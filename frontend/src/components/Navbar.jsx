        ...
        <div className="flex items-center gap-4">
          <div className="hidden sm:flex items-center gap-3 pl-4 border-l border-outline-variant/20">
            <div className="text-right">
              <p className="text-xs font-bold leading-none font-headline">{user?.username || 'Authenticated User'}</p>
              <p className="text-[10px] text-on-surface-variant uppercase tracking-[0.2em] leading-none mt-1.5 font-bold">Research Prototype</p>
            </div>
            <button
              onClick={logout}
